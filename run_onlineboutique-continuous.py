    ...
    for experiment in experiment_list:
        for routing_rule in routing_rule_list:
            ...
            if mode == "runtime":
                ...
                # slatelog = "stitched_df-checkout-profile-30bg.csv"
                # slatelog = "checkout-profile-30bg-replicated-e-c-s-trace.csv" # sample10
                # slatelog = "replicated-e-c-s-trace-sample5.csv"
                slatelog = "replicated-e-c-s-trace-sample1.csv"
                print(f"trace file: {slatelog}")
                print(f"trace file: {slatelog}")
                print(f"trace file: {slatelog}")
                print(f"trace file: {slatelog}")
                print(f"trace file: {slatelog}")
